...
public class EndpointB extends Node
{
	 ...
	 */
	EndpointB(Terminal t, String dstHost, int dstPort, int srcPort) {
		try {
			workerTerminal = t;
    ...
    public static void main(String[] args) {
		try {
			Terminal endpointTerminal = new Terminal("EndpointB");
			(new EndpointB(endpointTerminal, DEFAULT_DST_NODE, DEFAULT_DST_PORT, DEFAULT_SRC_PORT)).start();
